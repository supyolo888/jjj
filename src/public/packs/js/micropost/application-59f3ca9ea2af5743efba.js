...
$(window).on('scroll resize', function () {
  ...
  var $video = $('video'); // videoがページの最上部からどの位置にあるか取得

  var videoTop = $('video').offset().top; // videoの高さ取得

  var videoHeight = $('video').innerHeight(); // videoが停止している、かつvideoが画面内に入ってきた場合、再生処理
...
/******/ });
//# sourceMappingURL=application-59f3ca9ea2af5743efba.js.map