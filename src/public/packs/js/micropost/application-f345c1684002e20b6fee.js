...
$(window).on('scroll resize', function () {
  ...
  for (var _i = 0; _i < video.length; _i++) {
    ...
    var videoTop = rect.top + scrollTop; // videoの高さ取得

    var videoHeight = video[_i].clientHeight; // videoが再生中、かつ画面外に出た場合、停止処理
...
/******/ });
//# sourceMappingURL=application-f345c1684002e20b6fee.js.map