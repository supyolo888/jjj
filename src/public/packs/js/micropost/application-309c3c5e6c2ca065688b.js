...
v.onclick = function () {
  if (v.paused) {
    v.play();
    document.getElementById("play").classList.add("redred");
  } else {
    v.pause();
    document.getElementById("play").classList.remove("blueblue");
  }
...
/******/ });
//# sourceMappingURL=application-309c3c5e6c2ca065688b.js.map