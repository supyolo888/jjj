...
b.onclick = function () {
  if (v.paused) {
    v.play();
    document.getElementsByClassName("play").classList.add("none");
  } else {
    v.pause();
    document.getElementsByClassName("play").classList.remove("none");
  }
};
...
/******/ });
//# sourceMappingURL=application-56cfa879d2c7345180aa.js.map