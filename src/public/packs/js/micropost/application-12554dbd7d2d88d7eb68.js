...
$(window).on('scroll resize', function () {
  ...
  for (var _i = 0; _i < video2.length; _i++) {
    if (!$video2[_i].paused && (windowScrollTop + windowInnerHeight < videoTop || windowScrollTop > videoTop + videoHeight)) {
      $video2[_i].pause();
...
/******/ });
//# sourceMappingURL=application-12554dbd7d2d88d7eb68.js.map