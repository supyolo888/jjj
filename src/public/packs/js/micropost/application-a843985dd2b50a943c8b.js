...
var b = document.getElementsByClassName("playbtn");

b.onclick = function () {
  if (v.paused) {
    v.play();
    document.getElementsByClassName("fa-play").classList.add("none");
  } else {
    v.pause();
    document.getElementsByClassName("fa-play").classList.remove("none");
  }
};
...
/******/ });
//# sourceMappingURL=application-a843985dd2b50a943c8b.js.map