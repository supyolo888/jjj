...
$(window).on('scroll resize', function () {
  ...
  for (var _i = 0; _i < video.length; _i++) {
    ...
    var videoTop = video[_i].offset().top;

    var videoHeight = video[_i].innerHeight();

    if (!$video.paused && (windowScrollTop + windowInnerHeight < videoTop || windowScrollTop > videoTop + videoHeight)) {
      $video.pause();
...
/******/ });
//# sourceMappingURL=application-efac8505241a22b29d5e.js.map